...
function dTree(objName) {
	...
	this.config = {
        ...
        AddRemov        : true //Botones para la opcion de adicionar o quitar ramas

	}

	this.icon = {

		root			: 'fileproject/img/organigrama/base.gif',

		folder			: 'fileproject/img/organigrama/folder.gif',

		folderOpen		: 'fileproject/img/organigrama/folderopen.gif',

		node			: 'fileproject/img/organigrama/page.gif',

		empty			: 'fileproject/img/organigrama/empty.gif',

		line			: 'fileproject/img/organigrama/line.gif',

		join			: 'fileproject/img/organigrama/join.gif',

		joinBottom		: 'fileproject/img/organigrama/joinbottom.gif',

		plus			: 'fileproject/img/organigrama/plus.gif',

		plusBottom		: 'fileproject/img/organigrama/plusbottom.gif',

		minus			: 'fileproject/img/organigrama/minus.gif',

		minusBottom		: 'fileproject/img/organigrama/minusbottom.gif',

		nlPlus			: 'fileproject/img/organigrama/nolines_plus.gif',

		nlMinus			: 'fileproject/img/organigrama/nolines_minus.gif',
		
		middleLine		: 'fileproject/img/organigrama/myline2.gif',
		
		leftLine		: 'fileproject/img/organigrama/myline2.gif',
		
		smallLine		: 'fileproject/img/organigrama/smallLine.gif',
		
		rightLine		: 'fileproject/img/organigrama/myline2.gif',

        //
        addOg		    : 'fileproject/img/organigrama/add.gif',
        removeOg		: 'fileproject/img/organigrama/remove.gif'
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (node.url || ((!this.config.folderLinks || !node.url) && node._hc)){
        if(this.config.AddRemov){
          str += '</a> &nbsp;<img src="'+this.icon.addOg+'" style="cursor:pointer" onclick="javascript:fnl_add_org(\''+node.id+'\',\''+node.name+'\');"/>  <img src="'+this.icon.removeOg+'" style="cursor:pointer" onclick="javascript:fnl_remov_org(\''+node.id+'\',\''+node.name+'\');"/>&nbsp;&nbsp;&nbsp;';
        }else{
            str += '</a> &nbsp;&nbsp;';
        }
    }
