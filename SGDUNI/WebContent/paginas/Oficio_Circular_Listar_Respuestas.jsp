...
<script language="javascript" type="text/javascript">
  ...
  <div id="DivGrillaResul">
    ...
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
        <tr>
          <th width="4%" height="35" align="center" bgcolor="#E5E5E5" class="titu">ID</th>
        <th width="25%" bgcolor="#E5E5E5" class="titu">CODIGO OFICIO</th>
        <th width="22%" bgcolor="#E5E5E5" class="titu">USUARIO EMISOR</th>
        <th width="22%" bgcolor="#E5E5E5" class="titu">DEPENDENCIA</th>
        ...
        %>
            <tr>
                ...
                <td height="38" align="center" bgcolor="#E5E5E5">
                    <a href="ExportarOficioPDF.uni?idOficio=<%=oficio.getIn_codigo_oficio()%>&enviados=1" class="BotonStan2" title="Ver Oficio" target="_blank" >
                        <%=oficio.getCh_codigo_oficio() %>
                    </a>
                </td>
                <td class="textCont" > <%=oficio.getNombre_usuario_emisor() %> </td>
                <td class="textCont" > <%=oficio.getNombreDependFacu() %> </td>
