...
%>
    <div  class="tituloPag" align="center">
     <strong>Agregar Base Legal</strong>
    </div>

      <div class="formBody" style="width:610px;">
          <div class="textAviso" id="textAviso_rof_base">
           </div>
        <html:form action="guardarBaseLegalROF.uni" method="POST" styleClass="formulariosA1" styleId="frmRegiBaseLegal">
          <fieldset>
            ...
            <div align="center">
                <fieldset>
                 <legend></legend>
                   ...
                   <a href="javascript:;" id="cmdRegiNormaGenDir" class="BotonStan2 paddingCmd" style="text-decoration:none;" onclick="javascript:fnl_regiBaseLegal('<%=idRof%>');">Agregar</a>
