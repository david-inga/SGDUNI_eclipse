<%--
    Document   : REGISTAR NORMA GENERAL DE DIRECTIVAS
...
%>
    <div  class="tituloPag" align="center">
     <strong>Agregar Norma General a la Directiva <%=codDir%></strong>
    </div>

      <div class="formBody" style="width:610px;">
          <div class="textAviso" id="textAviso_direc_nor">
          </div>
        <html:form action="guardarNormaGenDirectiva.uni" method="POST" styleClass="formulariosA1" styleId="frmRegiNormaGen">
          <fieldset>
            <legend id="dvl_xuser">Datos de la Norma</legend>
            ...
            <div align="center">
                <fieldset>
                 <legend></legend>
                   ...
                   <a href="javascript:;" id="cmdRegiNormaGenDir" class="BotonStan2 paddingCmd" style="text-decoration:none;" onclick="javascript:fnl_regiNormaGenDir();">Agregar Norma</a>
