...
%>
    <div  class="tituloPag" align="center">
     <strong>Agregar Objetivo a la Directiva <%=codDir%></strong>
    </div>

      <div class="formBody" style="width:610px;">
          <div class="textAviso" id="textAviso_direc_obj">
           </div>
        <html:form action="guardarObjetivoDirectivas.uni" method="POST" styleClass="formulariosA1" styleId="frmRegiObjDir">
          <fieldset>
            <legend id="dvl_xuser">Datos del Objetivo</legend>
            ...
            <div align="center">
                <fieldset>
                 <legend></legend>
                   ...
                   <a href="javascript:;" id="cmdRegiObjDir" class="BotonStan2 paddingCmd" style="text-decoration:none;" onclick="javascript:fnl_regiObjetivoDir('<%=idDir%>');">Agregar Objetivo</a>
