...
public class Dependencia_insert extends org.apache.struts.action.Action {
            ...
            throws Exception
    {
        ...
        boolean estado = dao.guardarDependencia(objForm,nombre,id);

        if(estado == true)
        {
            objForm.setMensaje("Dependencia registrado correctarmente");
        }
        else
        {
            objForm.setMensaje("Error! ocurrio un error al registrar la dependencia");
        }
