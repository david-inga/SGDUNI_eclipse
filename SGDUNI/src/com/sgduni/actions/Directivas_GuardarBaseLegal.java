 ...
 * @author marco
 */
public class Directivas_GuardarBaseLegal extends org.apache.struts.action.Action {
            ...
            throws Exception
    {
        ...
        orpro_detalle_base_legal objForm = new orpro_detalle_base_legal();
        objForm.setIn_codigo_directiva(Integer.parseInt(cod_dirc) );
        objForm.setVc_descripcion(descrip);
        boolean estado = dao.agregarBaseLegalADirectiva(objForm,nombre,id);
        PrintWriter writer;
        try {
