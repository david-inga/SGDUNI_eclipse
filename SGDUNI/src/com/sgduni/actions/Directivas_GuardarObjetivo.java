 ...
 * @author marco
 */
public class Directivas_GuardarObjetivo extends org.apache.struts.action.Action {
            ...
            throws Exception
    {
        ...
        orpro_detalle_objetivo_direc objForm = new orpro_detalle_objetivo_direc();

        objForm.setIn_codigo_directiva(Integer.parseInt(cod_dirc) );
        objForm.setVc_descripcion(descrip);

        boolean estado = dao.agregarObjetivoADirectiva(objForm,nombre,id);
        PrintWriter writer;
        try {
        ...
        return null;
        //return mapping.findForward("registrarObjetivo");
    }
}
