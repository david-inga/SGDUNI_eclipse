 ...
 * @author marco
 */
public class Directivas_llamarFormInsertBaseLegal extends org.apache.struts.action.Action {
            ...
            throws Exception
    {
      System.out.println(" BASE LEGAL ");
        ...
        return mapping.findForward("registrarBaseLegal");
    }
}
