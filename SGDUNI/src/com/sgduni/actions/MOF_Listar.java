 ...
 * @author Sistemas
 */
public class MOF_Listar extends org.apache.struts.action.Action {
    ...
    String tipDepFac=(String)sesion.getAttribute("xtipodepen_facul").toString();
       ...
       {//Filtra sol para los usuario
          ArrayList<orpro_ta_mof> mofLis=daoMof.getListaMofPorUsuario(Integer.parseInt(idDepFacu), tipDepFac);
          request.setAttribute("mof", mofLis);
       }else
       {
            ArrayList<orpro_ta_mof> mofLis=daoMof.getListaMof();
            request.setAttribute("mof", mofLis);
       }
