 ...
 * @author Sistemas
 */
public class Observacion_Documentos_Gestion_Mapro_Guardar extends org.apache.struts.action.Action {
            ...
            throws Exception
    {
        ...
        int in_codigo_mapro=Integer.parseInt(request.getParameter("in_codigo_mapro"));
        int idEstado=0;
        ...
        orpro_ta_observaciones_mapro_DAO daoMAPRO=new orpro_ta_observaciones_mapro_DAO(dataSource);
        orpro_ta_observaciones_mapro theForm =new orpro_ta_observaciones_mapro();
        ...
        PrintWriter writer;
        try {
            theForm.setIn_codigo_mapro(in_codigo_mapro);
            theForm.setVc_observacion(vc_observacion);
           writer =response.getWriter();
            if(daoMAPRO.guardarObservacionMapro(theForm, idUser,idEstado))
            {
               writer.print("1");
            } else
            {
