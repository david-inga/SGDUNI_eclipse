 ...
 */
public class Oficio_Circular_Modificar_Aprobar extends org.apache.struts.action.Action {
    
    /* forward name="success" path="" */
    private final static String SUCCESS = "modificarAprobarOficio";
            ...
            throws Exception
    {
        ...
        if(dao.modificarOficio(objForm, idUser))
        {
           objForm.setMensaje("El Oficio fue modificado y aprobado correctamente");
        }
        else
        {
           objForm.setMensaje("Error! lo sentimos pero no se pudo modificar y/o aprobar el Oficio");
           request.setAttribute("mensaje_de_exito", "Error! lo sentimos pero no se pudo modificar y/o aprobar el Oficio");
        }
