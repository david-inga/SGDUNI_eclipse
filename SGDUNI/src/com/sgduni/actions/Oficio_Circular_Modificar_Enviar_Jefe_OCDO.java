 ...
 * @author JMarcos
 */
public class Oficio_Circular_Modificar_Enviar_Jefe_OCDO extends org.apache.struts.action.Action {
    
    /* forward name="success" path="" */
    private final static String SUCCESS = "modificarOficioyEnviar";
            ...
            throws Exception
    {
        ...
        if(dao.modificarOficio(objForm, idUser))
        {
           ...
           objForm.setMensaje("El Oficio se Envío al jefe(a) OCDO");
        }
        else
        {
           objForm.setMensaje("Error! lo sentimos pero no se pudo enviar el Oficio");
