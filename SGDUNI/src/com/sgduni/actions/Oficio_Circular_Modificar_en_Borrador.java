 ...
 * @author JMarcos
 */
public class Oficio_Circular_Modificar_en_Borrador extends org.apache.struts.action.Action {
    
    /* forward name="success" path="" */
    private final static String SUCCESS = "soloModificarOficio";
            ...
            throws Exception
    {
        ...
        {
           objForm.setMensaje("El Oficio se Modifico Correctamente");
        }
        else
        {
           objForm.setMensaje("Error! lo sentimos pero no se pudo Modificar el Oficio");
           request.setAttribute("mensaje_de_exito", "Error! lo sentimos pero no se pudo Modificar el Oficio");
        }
