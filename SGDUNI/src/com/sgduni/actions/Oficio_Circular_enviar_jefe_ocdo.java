 ...
 */
public class Oficio_Circular_enviar_jefe_ocdo extends org.apache.struts.action.Action {
    
    /* forward name="success" path="" */
    private final static String GUARDAR = "enviarJefeOCDO";
            ...
            throws Exception
    {
        ...
        {
           objForm.setMensaje("El Oficio fue Enviado al jefe(a) OCDO");
        }
        else
        {
           objForm.setMensaje("Error! lo sentimos, no se pudo enviar el oficio ");
           request.setAttribute("mensaje_de_exito", "Error! lo sentimos, no se pudo enviar el oficio ");
        }
