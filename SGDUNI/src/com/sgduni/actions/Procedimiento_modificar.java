 ...
 * @author marco
 */
public class Procedimiento_modificar extends org.apache.struts.action.Action {
            ...
            throws Exception
    {
        ...
        boolean estado =  dao.modificarProcedimiento(objForm,nombre,id);
        if(estado == true)
        {
            objForm.setMensaje("Procedimiento Modificado Correctamente");
        }
        else
        {
            objForm.setMensaje("Error! ocurrio un error al modificar el procedimiento");
        }
        return mapping.findForward("modificarProce");
    }
}
