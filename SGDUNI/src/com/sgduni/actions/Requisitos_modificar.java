 ...
 * @author marco
 */
public class Requisitos_modificar extends org.apache.struts.action.Action
{
            ...
            throws Exception
    {
        ...
        boolean estado =  dao.modificarRequisito(objForm,nombre,id);
        if(estado == true)
        {
            objForm.setMensaje("Requisito Modificado Correctamente");
        }
        else
        {
            objForm.setMensaje("Error! ocurrio un error al modificar el requisito");
        }
        return mapping.findForward("modificarReq");
    }
}
