 ...
 * @author Sistemas
 */
public class Versiones_Documentos_Gestion_Mof_Guardar extends org.apache.struts.action.Action {
            ...
            throws Exception
    {
        ...
        orpro_ta_versiones_mof theForm = (orpro_ta_versiones_mof) form;
        ...
        try {
             writer =response.getWriter();
              ...
              if (form instanceof orpro_ta_versiones_mof)
              {
                //Variables
              ...
              if(ErrorLoadFileT==0)
              {
                  if(daoMOF.guardarVersionMof(theForm, idUser,idEstado,NombreArchivo))
                  {
                     writer.print("<script language='javascript' type='text/javascript'>parent.fnl_doc_mof_resul(1)</script>");
                  }else{
                     writer.print("<script language='javascript' type='text/javascript'>parent.fnl_doc_mof_resul(0)</script>");
                  }
              }else
              {
                    writer.print("<script language='javascript' type='text/javascript'>parent.fnl_doc_mof_resul(0)</script>");
