 ...
 * @author Sistemas
 */
public class Versiones_Documentos_Gestion_Rof_Guardar extends org.apache.struts.action.Action {
            ...
            throws Exception
    {
        ...
        orpro_ta_versiones_rof theForm = (orpro_ta_versiones_rof) form;
        ...
        try {
             writer =response.getWriter();
              ...
              if (form instanceof orpro_ta_versiones_rof)
              {
                //Variables
              ...
              if(ErrorLoadFileT==0)
              {
                  if(daoROF.guardarVersionRof(theForm, idUser,idEstado,NombreArchivo))
                  {
                     writer.print("<script language='javascript' type='text/javascript'>parent.fnl_doc_rof_resul(1)</script>");
                  }else{
                     writer.print("<script language='javascript' type='text/javascript'>parent.fnl_doc_rof_resul(0)</script>");
                  }
              }else
              {
                    writer.print("<script language='javascript' type='text/javascript'>parent.fnl_doc_rof_resul(0)</script>");
            ...
            writer.flush();
            writer.close();
            Logger.getLogger(Versiones_Documentos_Gestion_Rof_Guardar.class.getName()).log(Level.SEVERE, null, ex);
        }
