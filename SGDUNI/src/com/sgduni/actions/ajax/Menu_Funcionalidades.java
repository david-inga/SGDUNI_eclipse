 ...
 * @author Sistemas
 */
public class Menu_Funcionalidades extends org.apache.struts.action.Action
{
            ...
            throws Exception
    {
        ...
        try {
           ...
           if(sesion.getAttribute("xrol")!=null)
           {
                    ...
                    String codHer=request.getParameter("ixmenu").toString();

                    orgen_ta_funcionalidad_DAO daoFun=new orgen_ta_funcionalidad_DAO(dataSource);
                    ArrayList<orgen_ta_funcionalidad> lista=daoFun.getFuncionalidadSegunHerramientarRolMenu(codHer, codRol);
