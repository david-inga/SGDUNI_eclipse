 ...
 * @author marco
 */
public class orgen_ta_clasi_cargo extends org.apache.struts.action.ActionForm {
    
    private Integer in_codigo_clasi;
    ...
    public Integer getIn_codigo_clasi() {
        return in_codigo_clasi;
    }

    public void setIn_codigo_clasi(Integer in_codigo_clasi) {
        this.in_codigo_clasi = in_codigo_clasi;
    }
