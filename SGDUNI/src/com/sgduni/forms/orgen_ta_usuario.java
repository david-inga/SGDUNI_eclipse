 ...
 * @author marco
 */
public class orgen_ta_usuario extends org.apache.struts.action.ActionForm {

    private FormFile vcfirma;
    ...
    private String txtnom_archivo_db;
    private String vc_grado_academico;
    ...
    public String getVc_grado_academico() {
        return vc_grado_academico;
    }

    public void setVc_grado_academico(String vc_grado_academico) {
        this.vc_grado_academico = vc_grado_academico;
    }

    public FormFile getVcfirma() {
        return vcfirma;
    }

    public void setVcfirma(FormFile vcfirma) {
        this.vcfirma = vcfirma;
    }



    public String getTxtnom_archivo_db() {
        return txtnom_archivo_db;
    }

    public void setTxtnom_archivo_db(String txtnom_archivo_db) {
        this.txtnom_archivo_db = txtnom_archivo_db;
    }
