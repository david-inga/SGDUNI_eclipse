 ...
 * @author Sistemas
 */
public class orpro_ta_mapro extends org.apache.struts.action.ActionForm {

    private int in_codigo_mapro;
    private String ch_codigo_mapro;
    ...
    public String getCh_codigo_mapro() {
        return ch_codigo_mapro;
    }

    public void setCh_codigo_mapro(String ch_codigo_mapro) {
        this.ch_codigo_mapro = ch_codigo_mapro;
    }
